# GEX Dashboard — Análisis de Gamma/Delta Exposure (SPX, NDX, SPY, QQQ)

*[Version française](README.md)* · *[English version](README.en.md)* · *[FAQ](FAQ.es.md)* · *[Aviso Legal](DISCLAIMER.md)*
...
60 s (timestamp del feed en UTC). Subyacentes seguidos: SPX, NDX, SPY y
QQQ (`gex/config.py`).
...
- **Cadenas nativas** SPX / NDX / SPY / QQQ (`gex/idxopt.py`) y NQ / ES
...
- **Veredicto por familia**: el régimen se juzga por clase de activo independiente
  — **S&P** (SPX/SPY/ES) y **Nasdaq** (NDX/QQQ/NQ) — y no símbolo por
  símbolo, con un peso mayor al índice cash que al ETF y luego al futuro.
...
- **Ajuste CFD automático**: conversión de precios de futuros CME a precios CFD
  de tu broker mediante Yahoo Finance o ajuste manual
- **Exportación a TradingView con 1 clic**: genera automáticamente la cadena
  de niveles para pegar en el indicador Pine Script incluido
...
- `gex/futopt.py` — cadenas de opciones sobre futuros NQ/ES vía dxFeed
